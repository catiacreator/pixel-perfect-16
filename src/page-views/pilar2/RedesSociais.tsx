...
<style>
  ...
  * { box-sizing: border-box; }
  body { font-family: Georgia, "Times New Roman", serif; color: #28323A; margin: 0; }
  .top { border-bottom: 3px solid #557588; padding-bottom: 12px; margin-bottom: 22px; }
  .kicker { font-family: Arial, sans-serif; font-size: 10px; letter-spacing: .28em; text-transform: uppercase; color: #557588; margin: 0 0 4px; }
  h1 { font-size: 26px; margin: 0; color: #28323A; }
  .sub { font-family: Arial, sans-serif; font-size: 12px; color: #8E7B64; margin: 4px 0 0; }
  table { width: 100%; border-collapse: collapse; }
  th { font-family: Arial, sans-serif; font-size: 10px; letter-spacing: .12em; text-transform: uppercase; color: #fff; background: #557588; text-align: left; padding: 9px 12px; }
  ...
  td.dia { font-weight: bold; color: #557588; white-space: nowrap; width: 90px; }
