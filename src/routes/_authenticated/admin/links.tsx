...
const SECCOES: Seccao[] = [
  ...
  },
  {
    ...
    paginas: [
      { nome: "Criação Livre (hub)", path: "/criacao-livre" },
      { nome: "Cria a tua série", path: "/metodo/pilar-2/reels-em-serie" },
      { nome: "Yap Content", path: "/metodo/pilar-2/redes-sociais?aba=formatos&fmt=roteiros" },
      { nome: "Reels virais", path: "/metodo/pilar-2/redes-sociais?aba=formatos&fmt=reels" },
      { nome: "Carrosséis virais", path: "/metodo/pilar-2/redes-sociais?aba=formatos&fmt=carrossel" },
      { nome: "Stories que vendem", path: "/metodo/pilar-2/redes-sociais?aba=formatos&fmt=stories" },
      { nome: "Automação de mensagens", path: "/metodo/pilar-2/redes-sociais?aba=automacao" },
      { nome: "Carousel Snap", path: "/metodo/pilar-2/redes-sociais?aba=carousel-snap" },
      { nome: "Agentes Creator", path: "/agentes-creator" },
    ],
  },
  {
