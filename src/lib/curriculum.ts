    ...
    modulos: [
      ...
      },
      {
        ...
        aulas: [
          ...
          { slug: "2-2", numero: "2.2", titulo: "Criar Robôs que Ajudam seus Clientes", resumo: "Como desenvolver robôs (GPTs) especializados que atendem ou ajudam diretamente os seus clientes." },
    ...
    modulos: [
      {
        ...
        aulas: [
          ...
          { slug: "1-4", numero: "1.4", titulo: "Como criar Skills no Claude", resumo: "Como criar as suas próprias Skills a partir do zero." },
          ...
          { slug: "1-8", numero: "1.8", titulo: "Claude in Chrome", resumo: "Instalar a extensão, analisar o seu Instagram, limpar e-mail, preencher formulários e usar \"perguntar antes de agir\"." },
    ...
    modulos: [
      {
        ...
        aulas: [
          ...
          { slug: "1-3", numero: "1.3", titulo: "Go Full Page", resumo: "Extensão do Chrome para tirar um screenshot completo da sua página." },
          ...
          { slug: "1-5", numero: "1.5", titulo: "Integrar Lovable no Claude Code", resumo: "Levar o seu app do Lovable para o Claude Code via GitHub." },
        ],
      },
    ],
  },
