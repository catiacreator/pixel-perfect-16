        ...
        filhos: [
          ...
          { id: "redes.bio", label: "Posicionamento e Bio", tipo: "pagina", to: "/metodo/pilar-2/redes-sociais?aba=bio" },
          {
            ...
            filhos: [
              ...
              { id: "redes.formatos.estatico", label: "Post estático", tipo: "subpagina", to: "/metodo/pilar-2/redes-sociais?aba=formatos&fmt=estatico" },
            ],
          },
  ...
  },
  {
    ...
    filhos: [
      ...
      { id: "conteudo-ia.reels-serie", label: "Reels em Série", tipo: "pagina", to: "/conteudo-ia?aula=reels-serie" },
      {
        ...
        filhos: [
          { id: "conteudo-ia.roubar-garimpar", label: "Passo 01 · Bisbilhotar Conteúdo", tipo: "subpagina", to: "/conteudo-ia?aula=roubar-garimpar" },
          ...
          { id: "conteudo-ia.roubar-formato", label: "Passo 04 · Modela o Formato", tipo: "subpagina", to: "/conteudo-ia?aula=roubar-formato" },
          { id: "conteudo-ia.roubar-medir", label: "Passo 05 · Publicar e medir", tipo: "subpagina", to: "/conteudo-ia?aula=roubar-medir" },
        ],
      },
