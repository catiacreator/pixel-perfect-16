...
export default function ModulePaywall({ module, signedIn }: { module: ModuleKey; signedIn: boolean }) {
  ...
  return (
    <div className="max-w-xl mx-auto px-5 py-16 md:py-24 text-center">
      ...
      <p className="text-[11px] tracking-[0.28em] uppercase text-terracotta font-semibold mb-2">Módulo bloqueado</p>
      <h1 className="font-display text-3xl md:text-4xl text-ink tracking-tight">{info.label}</h1>
      <p className="text-ink/60 mt-3 leading-relaxed">
        Este conteúdo faz parte de um produto da Leveza no Digital. Desbloqueie-o com a compra na Hotmart —
        o acesso liberta-se automaticamente para o seu email.
      </p>
      ...
      <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
        {info.checkoutUrl ? (
          ...
          >
            Desbloquear na Hotmart <ArrowUpRight size={15} strokeWidth={2.25} />
          </a>
        ) : (
