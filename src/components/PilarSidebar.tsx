    ...
    items: [
      ...
      },
      {
        ...
        children: [
          ...
          { label: "3 · Imagens e infográficos", to: "/conteudo-ia?aula=m4c" },
      ...
      { num: 7, id: "conteudo-ia.reels-serie", label: "Reels em Série", to: "/conteudo-ia?aula=reels-serie", icon: Video, badge: "Em breve" },
      { num: 8, id: "conteudo-ia.bonus", label: "Banco de prompts", to: "/conteudo-ia?aula=bonus", icon: Book },
      { num: 9, id: "conteudo-ia.final", label: "O teu próximo passo", to: "/conteudo-ia?aula=final", icon: Sparkles },
    ],
  },
  academia: {
    pilar: "academia",
