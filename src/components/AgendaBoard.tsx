...
import { Plus, X, Trash2, GripVertical, Link2 } from "lucide-react";

/** Quadro de tarefas (kanban) reutilizável — usado na página /agenda e embebido na jornada. */
          ...
          return (
            ...
            >
              <div className="flex items-center justify-between px-2 py-1.5 mb-2">
                <span className="text-[11px] tracking-[0.18em] uppercase text-ink/60 font-medium">{col.titulo}</span>
